...
class RolloutBuffer:
    ...
    def add_observation(self, obs):
        ...
        for agent_id in range(self.num_agents):
            self.current_rollout_states[agent_id].append({"obs": obs["obs"][agent_id], "next_obs": obs["next_obs"][agent_id]})
    ...
    def end_rollout(self):
        ...
        for agent_id in range(self.num_agents):
            self.rollout_history[agent_id].append(self.current_rollout_states[agent_id])  # (n_rollout_steps, n_rollout_threads, n_truncated_obs_dim)
            self.current_rollout_states[agent_id] = []
        
        return self.all_rollouts_mean_state
